...
public class InputCheckerMethods {
    ...
    public static boolean sameCategoryDescriptionInput(String description
            , Category[] categories) throws SameFileErrror {
    ...
    static boolean sameNameChecker(String name, Category[] categories) {
    ...
    public static boolean sameItemInputChecker(Item[] pickedItems, Item selectedItem) throws SameItemException {
