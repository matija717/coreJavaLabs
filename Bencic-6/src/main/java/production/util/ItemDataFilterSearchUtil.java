...
public class ItemDataFilterSearchUtil {
    private ItemDataFilterSearchUtil(){
        throw new AssertionError("ItemDataFilterSearchUtil should not be instantiated");
    }
    ...
    public static String findMostCheapestAndMostExpensiveItemAmongTechnical(List<Item> allItems) {
        ...
        return "\nMost cheapest item within Technical is "
