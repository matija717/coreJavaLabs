...
public class BananaAddScreenController {
    @FXML
    ...
    public void saveBanana() {
        ...
        try {
            ...
            items.add(new Banana(item.getName()
                    , item.getId()
                    , item.getObject()
                    , item.getWidth()
                    , item.getHeight()
                    ...
                    , weight));
            FileUtils.saveBananas(items);
        } catch (RuntimeException e) {
            showErrorAlert(BananaAddScreenController.class.getSimpleName());
        }
