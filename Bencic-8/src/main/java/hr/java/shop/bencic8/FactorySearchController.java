...
import hr.java.shop.bencic8.production.model.Address;
import hr.java.shop.bencic8.production.model.Factory;
...
public class FactorySearchController {
    ...
    public void initialize() {
        ...
        numberOfItemsTableColumn.setCellValueFactory(cellData ->
                new SimpleStringProperty(String.valueOf(cellData.getValue().getItems().size())));
    ...
    public void searchFactories() {
        ...
        showSearchAlert(factoryNameTextField.getText(), cityOfFactoryChoiceBox.getValue() == null
                ? "" : cityOfFactoryChoiceBox.getSelectionModel().getSelectedItem());
    }
