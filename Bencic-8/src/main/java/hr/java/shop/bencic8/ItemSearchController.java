...
public class ItemSearchController {
    ...
    public void initialize() {
        restrictToAlphabeticInput(itemNameTextField );
    ...
    public void searchItems() {
        List<Item> itemList = FileUtils.allItems();
        ...
        showSearchAlert(itemNameTextField.getText(), categoryToPick.getValue() == null ? "" :
                categoryToPick.getSelectionModel().getSelectedItem());
